      ...
      <Center>
        <Flex flexDirection="column" ms={4} w="60%">
          <Box borderRadius={8} bg="purple.50" mt={8} p={4}>
            ...
            <Box mt={10}>
              <Text>
                {ceo} é o CEO da {data.company.name}. A empresa foi fundada em{" "}
                {data.company.founded}.
              </Text>
              <Text>Para saber mais sobre a empresa...</Text>
              <Center mt={4}>
                <Button colorScheme="red" onClick={handleRedirectToAbout}>
                  Saiba mais
                </Button>
              </Center>
            </Box>
          ...
          <Box borderRadius={8} bg="purple.50" mt={8} p={4}>
            ...
            <Box mt={10}>
              ...
              <Center mt={4}>
                <Button colorScheme="red" onClick={handleRedirectToSearch}>
                  Busque Foguetes
                </Button>
              </Center>
            </Box>
